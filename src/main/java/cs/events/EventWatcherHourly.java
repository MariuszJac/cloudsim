...
public class EventWatcherHourly implements SimulationClockEvent{
	...
	public void triggerEvent() {
		try
		{
			logger.debug("---> hourly event triggered by simplatform clock...");
			//logger.info("Current simulation time: "+modelInterface.getSimulationClock().getCurrentTime().getTime().toGMTString()+" end time: "+modelInterface.getSimulationClock().getEndTime().getTime().toGMTString());
